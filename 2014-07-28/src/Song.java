...
secondi. Una playlist è una lista di canzoni, compresi eventuali duplicati, ed ore il metodo add,
che aggiunge una canzone in coda alla lista, e remove, che rimuove tutte le occorrenze di una
canzone dalla lista. Inne, la classe Playlist è dotata di ordinamento naturale basato sulla durata
